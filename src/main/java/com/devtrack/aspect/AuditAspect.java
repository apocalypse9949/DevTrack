...
public class AuditAspect {
    ...
    @AfterReturning(pointcut = "@annotation(com.devtrack.aspect.Auditable)", returning = "result")
    public void auditMethodExecution(JoinPoint joinPoint, Object result) {
        try {
            ...
            // Extract arguments as details summary
            ...
            // Scrub passwords or sensitive data from details summary
